...
alias gjws='cd ~/dev/workspaceJava'
alias gpws='cd ~/dev/workspaceCppPy'
alias clip='xclip -selection c'
alias dateclip='date | clip'
alias charles='~/dev/charles/bin/charles'
# alias apt-get-clear-cache='sudo apt-get clean && sudo rm -R /var/lib/apt/lists.bkp && sudo mv /var/lib/apt/lists /var/lib/apt/lists.bkp && sudo mkdir -p /var/lib/apt/lists/partial && sudo apt-get clean && sudo apt-get update'
# alias apt-get-clear-cache2='sudo aptitude -o Acquire::http::No-Cache=True -o Acquire::BrokenProxy=true update'
CDPATH='.:~:~/dev'
